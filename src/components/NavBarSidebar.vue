              ...
              <div>
                ...
                >
                  <div class="flex-shrink-0">
                    <img class="rounded-full w-11 h-11" :src="logo" alt="Jese image" />
                    <div
                ...
                >
                  <div class="flex-shrink-0">
                    <img class="rounded-full w-11 h-11" :src="logo" alt="Joseph image" />
                    <div
                ...
                >
                  <div class="flex-shrink-0">
                    <img class="rounded-full w-11 h-11" :src="logo" alt="Leslie image" />
                    <div
                ...
                <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                  <div class="flex-shrink-0">
                    <img class="rounded-full w-11 h-11" :src="logo" alt="Robert image" />
                    <div
