  ...
  <div>
    ...
    >
      ...
      >
        <div
          :class="{
            'flex flex-col flex-1 pt-5 pb-28 overflow-y-auto': true,
            'scrollbar scrollbar-w-2 scrollbar-thumb-rounded-[0.1667rem]': true,
            'scrollbar-thumb-slate-200 scrollbar-track-gray-400': true,
            'dark:scrollbar-thumb-slate-900 dark:scrollbar-track-gray-800': true,
          }"
        >
          <div
          ...
          >
            <ul class="pb-2 space-y-2">
              ...
              <li>
                ...
                <ul :class="{ hidden: !openDropdowns.categories }" class="py-2 space-y-2">
                  <li>
                    <RouterLink
                      to="/category/add"
              ...
              <li>
                ...
                <ul :class="{ hidden: !openDropdowns.events }" class="space-y-2 py-2">
                  <li>
                    <RouterLink
                      to="/event/add"
              ...
              <li>
                ...
                <ul :class="{ hidden: !openDropdowns.users }" class="py-2 space-y-2">
                  <li>
                    <RouterLink
                      to="/users/manage"
                      class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
              ...
              <!-- <li>
                ...
                <ul :class="{ hidden: !openDropdowns.profile }" class="py-2 space-y-2">
                  <li>
                    <RouterLink
                      to="/profile"
                      class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
